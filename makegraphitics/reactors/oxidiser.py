...
class Oxidiser(Reactor):
    ...
    def find_12_neighbours(self, crystal, i, j):
        ...
        first_neighbours = [int(n) + 1 for n in first_neighbours]
        ...
        for n in first_neighbours:
            second_neighbours = second_neighbours | set(crystal.bonded_to(int(n) - 1))
        second_neighbours = {int(n) + 1 for n in second_neighbours}
